...
$lang = array_merge($lang, array(
	'COOKIE_ACCEPT_TEXT'	=> 'Ce forum utilise les cookies pour vous offrir la meilleure et la plus pertinente des expériences utilisateur. Pour utiliser ce forum, vous avez besoin d’accepter sa politique.<br /><br />Pour en savoir plus sur les cookies utilisés cliquez sur la « Politique des cookies » depuis la page principale ou via le lien ci-dessous.<br />',
	'COOKIE_ACCEPT'			=> '[ J’accepte ]',
	'COOKIE_ACCESS'			=> 'Accès aux cookies',

	'COOKIE_BLOCK'			=> 'Vous ne pouvez pas accéder aux liens sur ce forum tant que vous n’acceptez pas la politique des cookies.',
...
<h3>Est-ce qu’un utilisateur du forum peut bloquer les cookies ?</h3><p>Pour savoir comment gérer les cookies que vous autorisez, voir la rubrique d’aide de votre navigateur ou le manuel de votre appareil mobile - ou vous pouvez visiter l’un des sites ci-dessous qui contiennent des informations détaillées sur la façon de gérer, de contrôler ou de supprimer les cookies.<br /><br />
...
<h3>Les cookies sur %1$s provenant des sites des réseaux sociaux</h3><p>%1$s peut avoir des liens vers des sites de réseaux sociaux (exemple Facebook, Twitter ou YouTube). Ces sites peuvent également placer des cookies sur votre appareil et %1$s ne gère pas la façon dont ils utilisent leurs cookies, donc %1$s vous suggère de vérifier leurs sites pour voir comment ils utilisent les cookies.',
	...
	<p>Vous devez accepter la politique des cookies de %1$s avant de pouvoir vous inscrire sur ce site ou, si vous êtes déjà inscrit, avant de vous connecter au site.</p>',
));
